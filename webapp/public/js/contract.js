...
const YourContractABI = [
  {
    ...
    sources: {
      "github/Katlehoseatlholo/Capstone_2023/contracts/Contract.sol": {
        keccak256:
          "0x0d596f8624dd3a4474acfb023eef7d39ef609e4edb0d90bb977b7822517b0fd0",
        license: "MIT",
        urls: [
...
// Function to initialize Web3 and MetaMask
...
document.getElementById("acceptConditions").addEventListener("click", handleVoteClick);
...
async function checkWalletConnection() {
    const accounts = await web3.eth.getAccounts();
    const connectWalletButton = document.getElementById("acceptConditions");
  
    if (accounts.length > 0) {
      alert("You have already connected your wallet.");
    } else {
      // Modify the button text when the wallet is not connected
...
document.getElementById("acceptConditions").addEventListener("click", () => {
    checkWalletConnection(); // Call the checkWalletConnection function
  });
